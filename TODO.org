...
** Protocol versions
*** 9p2000
Open can create files and directories.
Read can read dirents from directories.
*** 9p2000.U
*** 9p2000.L
...
~/Projects/scripts/projects/todo.sh bin lib spec | awk '// { printf("*** %s\n", $0) }'
#+END_SRC
...
*** TODO test creating in directories that do not exist [[file:lib/nonop/client/remote-file.rb::79]]
*** TODO length limited to msglen [[file:lib/nonop/client/remote-file.rb::111]]
*** TODO handling multiple replies for big reads [[file:lib/nonop/client/remote-file.rb::112]]
...
*** TODO why? [[file:lib/nonop/server/connection.rb::338]]
*** FIXME deadlocks the show, when #wait needs a Fiber scheduler [[file:lib/nonop/thread-pool.rb::352]]
*** TODO start tasks in parallel w/ dead lock [[file:lib/nonop/thread-pool.rb::365]]
*** TODO zip the factorings and twins [[file:lib/nonop/thread-pool.rb::369]]
*** TODO errors? no block... [[file:lib/nonop/client/remote-dir.rb::31]]
*** TODO an async version to complement an enumerable; needs to pass a continuation to ~blk~ [[file:lib/nonop/client/remote-dir.rb::55]]
...
*** TODO cache in the data provider so the fsid sees a consistent list [[file:lib/nonop/server/file-system/path-entry.rb::225]]
...
*** TODO iounit is the default read block size the server supports for a file [[file:spec/integration/client/lopen.rb::6]]
*** TODO ENOENT? [[file:spec/integration/client/lopen.rb::27]]
*** TODO UID & GID checks [[file:spec/integration/client/lopen.rb::164]]
*** TODO hov to fill the fifo w/ backend independence? [[file:spec/integration/client/read.rb::160]]
*** FIXME need a ready signal of sorts [[file:spec/spec-helper.rb::32]]
*** FIXME testing DirectoryEntry more so w/ the spec-fs; PathEntry hits real files. Paths to files need to be specified; test dir setup [[file:spec/integration/backends/path-entry.spec::38]]
*** TODO better [[file:spec/integration/client/statfs.rb::49]]
*** TODO use new afid for attach? [[file:spec/integration/client/statfs.rb::89]]
*** TODO better [[file:spec/integration/client/statfs.rb::117]]
*** TODO wide and deep directories [[file:spec/integration/client/readdir.rb::7]]
*** TODO umode and ACL cases [[file:spec/integration/client/readdir.rb::8]]
*** TODO why +1? [[file:spec/integration/client/readdir.rb::93]]
...
#+BEGIN_SRC sh :results output raw
bundle exec sg-rspec-report --style org < doc/spec.json
#+END_SRC
...
#+NAME spec-proto-op-status
#+BEGIN_SRC sh :results output raw
bundle exec ./scripts/spec-proto-op-status.rb --style org < doc/spec.json
#+END_SRC
...
| Tmknod    | false |               |             |
| Topen     | false |               |             |
| Tread     | false | 79% (139/177) | 7% (12/177) |
| Treaddir  | false |               |             |
| Treadlink | false |               |             |
| Tremove   | false |               |             |
| Trename   | false |               |             |
| Tsetattr  | false |               |             |
| Tstat     | false | 94% (15/16)   |             |
| Tstatfs   | false |               |             |
| Tsymlink  | false |               |             |
